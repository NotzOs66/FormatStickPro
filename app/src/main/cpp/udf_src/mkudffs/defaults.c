...
struct fileEntry default_fe =
{
	...
	.permissions = constant_cpu_to_le32(FE_PERM_U_DELETE|FE_PERM_U_CHATTR|FE_PERM_U_READ|FE_PERM_U_WRITE|FE_PERM_U_EXEC|FE_PERM_G_DELETE|FE_PERM_G_CHATTR|FE_PERM_G_READ|FE_PERM_G_WRITE|FE_PERM_G_EXEC|FE_PERM_O_DELETE|FE_PERM_O_CHATTR|FE_PERM_O_READ|FE_PERM_O_WRITE|FE_PERM_O_EXEC),
